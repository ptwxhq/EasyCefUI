...
#if CEF_VERSION_MAJOR != 87 && CEF_VERSION_MAJOR != 90 && CEF_VERSION_MAJOR != 94 && CEF_VERSION_MAJOR != 96
#pragma message("!!!!WARNNING:This project is base tested on Cef ver 87/90/94/96, maybe fail to build on other versions.!!!!")
#endif
